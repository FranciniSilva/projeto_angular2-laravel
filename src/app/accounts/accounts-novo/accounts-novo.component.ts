...
@Component({
  selector: 'app-accounts-novo',
  templateUrl: './accounts-novo.component.html',
  styleUrls: ['./accounts-novo.component.css']
})
export class AccountsNovoComponent implements OnInit {
